package com.springtest.landon.web.application;

import com.springtest.landon.business.domain.RoomReservation;
import com.springtest.landon.business.service.ReservationService;
...
public class ReservationControllerTest {
    ...
    public void getReservations() throws Exception{
        ...
        given(reservationService.getRoomReservationsForDate(date.toString())).willReturn(mockReservationList);
